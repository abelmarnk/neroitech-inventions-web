...
interface BulletProps { icon: ReactNode; title: string; text: string; }
...
export const LearnMoreModal: React.FC<LearnMoreModalProps> = ({ open, onClose }) => {
  return (
    <BaseModal open={open} onClose={onClose} title="What is SnappQuest?">
      <div className="space-y-8">
        <p className="text-gray-700 text-base leading-relaxed">
          SnappQuest is a lightweight quest management and community engagement concept. It lets creators
          define goal‑oriented quests with structured tasks, reward logic, and social proof components. This prototype
          showcases a Next.js + Framer Motion modernization of a prior static site.
        </p>
        ...
        <div className="bg-indigo-50 rounded-xl p-6 border border-indigo-100">
          ...
          <p className="text-indigo-700 text-sm leading-relaxed">
            Migrating from a static HTML bundle to a componentized Next.js architecture enables scalability, dynamic
            wallet integration, animation, and better developer ergonomics.
          </p>
        </div>
      </div>
    </BaseModal>
